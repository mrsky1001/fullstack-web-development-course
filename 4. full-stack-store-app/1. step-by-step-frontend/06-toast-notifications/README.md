...
- [ ] `document.createElement()` создает элемент в памяти
- [ ] `appendChild()` добавляет элемент в DOM
- [ ] `remove()` удаляет элемент из DOM
- [ ] CSS-переходы `transition` создают плавные анимации
- [ ] Класс добавляется с задержкой, чтобы браузер успел "увидеть" изменение
