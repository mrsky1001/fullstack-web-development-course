...
// Копирование массива
const arrCopy = [...arr1];
console.log('Копирование массива:', arrCopy); // [1, 2, 3]

// Слияние массивов
const mergedArray = [...arr1, ...arr2];
console.log('Слияние массивов:', mergedArray); // [1, 2, 3, 4, 5, 6]

// Добавление элементов
const newArray = [0, ...arr1, 4];
console.log('Добавление элементов:', newArray); // [0, 1, 2, 3, 4]
...
// Копирование объекта
const objCopy = { ...obj1 };
console.log('Копирование объекта:', objCopy); // { a: 1, b: 2 }

// Слияние объектов
const mergedObject = { ...obj1, ...obj2 };
console.log('Слияние объектов:', mergedObject); // { a: 1, b: 2, c: 3, d: 4 }
...
console.log('Rest в массивах:', first, second, rest); // 1 2 [3, 4, 5]

// В деструктуризации объектов
const { a, ...otherProps } = { a: 1, b: 2, c: 3, d: 4 };
console.log('Rest в объектах:', a, otherProps); // 1 { b: 2, c: 3, d: 4 }
