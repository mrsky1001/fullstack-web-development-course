...
console.log('Object.fromEntries():', newObj); // { a: 1, b: 2. Добавляем только html + css, c: 3 }
...
console.log('Отсортированный объект:', sorted); // { a: 1, m: 2. Добавляем только html + css, z: 3 }
