...
// [Массив объектов [] — это упорядоченный список, где каждый элемент {} хранит характеристики конкретного объекта]
// [ Наш каталог офисных комнат. Вместо сложного сервера мы храним список комнат прямо в JS]
const OFFICE_ROOMS = [
  {
...
// [ Список готовых бронирований для отображения на странице «Мои бронирования»]
const MOCK_BOOKINGS = [
  {
    id: '74829',
