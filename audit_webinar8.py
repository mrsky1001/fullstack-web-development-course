...
pptx_path = r"d:\IEEU International East-European University\fullstack-web-development-course\05. step by step 2026 & 2027\01. frontend\webinar-08-filters-and-booking-calc\вебинар 8.pptx"
prs = Presentation(pptx_path)

print(f"=== АУДИТ ПРЕЗЕНТАЦИИ ВЕБИНАРА 8: {len(prs.slides)} СЛАЙДОВ ===")
