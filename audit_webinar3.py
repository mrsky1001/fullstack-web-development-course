...
pptx_path = r"d:\IEEU International East-European University\fullstack-web-development-course\05. step by step 2026 & 2027\01. frontend\webinar-03-flexbox-grid-cards\вебинар 3.pptx"
prs = Presentation(pptx_path)

print(f"=== АУДИТ ПРЕЗЕНТАЦИИ: {len(prs.slides)} СЛАЙДОВ ===")
...
for i, slide in enumerate(prs.slides):
    ...
    if slide_num not in [1, 2, 26] and not has_tb2:
...
print("\n--- ПЕРВЫЕ 2 И ПОСЛЕДНИЕ 2 СЛАЙДА ---")
for s_idx in [0, 1, 24, 25]:
    sl = prs.slides[s_idx]
